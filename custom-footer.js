...
function clickIconBox(container, element, colorPre, colorPost, formField=false, cookieKey=false) {
    /*
    ...
    setTimeout(() => {
        ...
        if(currElement[0].id != element[0].id) {
            ...
            currElement.on("click", () => {
                clickIconBox(container, currElement, colorPre, colorPost, formField, cookieKey);
                if(formField) {
                    formField.val(currElement.find('h3')[0].innerHTML);
                };
                if(cookieKey) {
                    setCookie(cookieKey, currElement.find('h3')[0].innerHTML, 30);
                };
            });
        };
        };
...
$(document).ready(() => {
    ...
    -------------------------------------------------------------------- */
        ...
        $('#edu-tutoring-form-1-1').on("click", () => {
            clickIconBox($('#edu-tutoring-form-1'), $('#edu-tutoring-form-1-1'), '#FFFFFF', '#969939', false, "edu-tutoring-input-1");
        ...
        $('#edu-tutoring-form-1-2').on("click", () => {
            clickIconBox($('#edu-tutoring-form-1'), $('#edu-tutoring-form-1-2'), '#FFFFFF', '#969939', false, "edu-tutoring-input-1");
        });
        ...
        $('#edu-tutoring-form-1-3').on("click", () => {
            clickIconBox($('#edu-tutoring-form-1'), $('#edu-tutoring-form-1-3'), '#FFFFFF', '#969939', false, "edu-tutoring-input-1");
        });
        ...
        $('#edu-tutoring-form-2-1').on("click", () => {
            clickIconBox($('#edu-tutoring-form-2'), $('#edu-tutoring-form-2-1'), '#FFFFFF', '#969939', false, "edu-tutoring-input-2");
        });
        ...
        $('#edu-tutoring-form-2-2').on("click", () => {
            clickIconBox($('#edu-tutoring-form-2'), $('#edu-tutoring-form-2-2'), '#FFFFFF', '#969939', false, "edu-tutoring-input-2");
        });
        ...
        $('#edu-tutoring-form-2-3').on("click", () => {
            clickIconBox($('#edu-tutoring-form-2'), $('#edu-tutoring-form-2-3'), '#FFFFFF', '#969939', false, "edu-tutoring-input-2");
        });
        ...
        $('#edu-tutoring-form-3-1').on("click", () => {
            clickIconBox($('#edu-tutoring-form-3'), $('#edu-tutoring-form-3-1'), '#FFFFFF', '#969939', false, "edu-tutoring-input-3");
        });
        ...
        $('#edu-tutoring-form-3-2').on("click", () => {
            clickIconBox($('#edu-tutoring-form-3'), $('#edu-tutoring-form-3-2'), '#FFFFFF', '#969939', false, "edu-tutoring-input-3");
        });
        ...
        $('#edu-tutoring-form-3-3').on("click", () => {
            clickIconBox($('#edu-tutoring-form-3'), $('#edu-tutoring-form-3-3'), '#FFFFFF', '#969939', false, "edu-tutoring-input-3");
            console.log(getCookie("edu-tutoring-input-3"), getCookie("edu-tutoring-input-2"), getCookie("edu-tutoring-input-1"));
        });
});